...
- **Campaign**: Myrrindar — Winds of Warding
...
| Feat | Source | Effect |
|------|--------|--------|
| Entertainer ASI | Background (Lv1) | +2/+1 ability score increase |
| Musician | PHB-2024 | 3 instrument proficiencies; Encouraging Song (Short/Long Rest — play a song on a proficient instrument to give Heroic Inspiration to up to 2 allies) |

## Spells

### Spellcasting: CHA — DC 13, Attack +5
...
- **Tools**: Clarinet, Fiddle, Flute, Harp, Lute, Lyre, Songhorn
- **Languages**: Common, Primordial
...
- **Traits**: I like to squeeze into small places where no one else can get to me.
...
**"The Mischief Debuff King"** — Win every social interaction through deception and performance. In combat, don't need to deal damage — make enemies deal less damage or take more damage from allies. Pure control and support.
