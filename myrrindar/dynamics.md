# Party Dynamics — Myrrindar: Winds of Warding
...
## Backstory Snapshot *(established S6, breakfast introductions)*
...
- **Post-Silas gaps**: Combat-wise the party is fine — Avon was the real frontline and tank all along, Talya adds skirmisher melee. The actual gap is skill coverage: no Rogue means no Reliable Talent on stealth/sleight of hand, and lock/trap detection falls to Mist or Talya. Mist could pivot Bardic Expertise toward Stealth + Sleight of Hand if Pax wants to lean into the scout/infiltrator niche now that the lane is open.
- **Avon as anchor**: With heavy armor + shield + STR build, Avon holds the chokepoint and soaks hits while Talya flanks. Mist's Healing Word keeps him up; Bardic Inspiration on his attack rolls stretches his offensive contribution.
- **Dissonant Whispers + Melee Allies**: Forced movement from Dissonant Whispers provokes opportunity attacks from Avon and Talya — position them adjacent first.
...
- **Veilbearer Mikos** *(introduced S6 by mention)* — Rowan's direct Vale Tempest supervisor.
- **Rowan** *(introduced S6)* — Vale Tempest Initiate defector, party-sheltered. +0 to everything, ~15-20 HP. Currently being hidden at the Temple of Bahamut.
...
- **Avon ↔ Carrie-Anne**: Carrie-Anne recognized Avon by reputation from Sevra. Invited him to visit the Bahamut temple. Avon promised to go "when he can." Something larger is going on — the clerics have "heard his tales."
- **Silas ↔ Evrin** *(updated S5)*: Former crewmates — Silas was the top member, Evrin was third and looked up to him. Evrin "almost left with him" when Silas departed the crew. In Session 5, Silas vanished into a magic circle in the Stillwind Lab vault. Evrin was visibly concerned (Mist + Loren caught the hide on Insight 17/21) but maintained composure. Evrin claims to be following Silas's moral code in his current organization.
- **Party ↔ Evrin** *(established S5)*: Patron / employer relationship. Original Whisper Prism deal completed and paid. Long-term contract verbally agreed: Mist + Talya in (Mist negotiated a signing bonus via Persuasion 25), Akasha extended-alliance-only with retained right to refuse jobs, Avon undecided/silent. Evrin pitched a populist reformer-criminal vision — Mist (Insight 6) was moved; Avon and Akasha more skeptical. Not entirely trusted: Mist + Avon are keeping the orb-vision secret from him. Code phrase to summon: *"purchase a seagull"* via Crowned Pheasant barkeep.
- **Party ↔ Loren Lyster** *(cameo, S5)*: Friendly contractor relationship. Loren Lyster (Path of the Zealot Barbarian, 4'10", blonde) was professional, refused a treasure cut, helped kill the Vault Guardian (max Divine Fury Radiant greataxe to the neck, 19 damage). Departed after escorting party to Evrin. Implied she'd return if hired by Evrin alongside the party.
- **Mist ↔ Sylvia Plath** *(introduced S5)*: Mist knows of her professionally with a thread of jealousy. Loren did security for her in the past. Possible future contact.
- **Akasha ↔ Thalren Deepbloom** *(established S6)*: Allied. Thalren recognized Akasha's Whispering Canopy / mother-tree blight context immediately and gave her the **seed of renewal**. He's now en route to Iliora to investigate the blight himself.
- **Party ↔ Rowan** *(established S6)*: Sheltering relationship (party-as-protector). Rowan defected after disclosing the Wardstone truth under amulet-bound compulsion. Mist explicitly framed the deal as utility-based (*"at least he can be a shield for us"*); Akasha framed it as adoption (*"Yay! It's our pet"*). Rowan: *"I'll do my best."*
...
- **Neulvyn** — Mist's fairy homeland. Does it still exist? Mist hasn't been back in 2-3 years.
- **The Fae Traffickers** — Captured Mist and his childhood friends. Still likely active.
- **The Noble Captor** — Unnamed Skybreeze noble who kept Mist as a collection piece. Scandal collapsed the household — current fate unknown.
- **Eldrin** — Elven bard mentor, vanished from Skybreeze. Where and why?
- **Skybreeze streets** — Mist's contacts, rivals, debts from his survival years.
- **Mist's kidnappers / Neulvyn** *(activated S6)* — Avon and Akasha offered to help track them. Lead now open. Possibly the Bahamut clerical network can pursue without Mist running point.
- **The Frozen Tableau / red crystal in gold housing** — Mist + Avon still investigating quietly. Library suppression is now a wrinkle.

### Per-Character

- **Talya's old crew / shipwreck** *(activated S6)* — Where did the ship go? Who survived?
- **Avon's vision from Bahamut** — Came to Skybreeze; "some sort of danger." Now more concrete after the Wardstone reveal.
- **Akasha's Circle of the Stars** — Sole apprentice; elders await answers about the blight.

### Dormant / Background

- **Five enchanted targets** — Elias Whitmore, Rufus Dawnstrider, Valo, Regina, Bildren. Rufus is the most accessible lead (Mist knows him). Untouched since Session 3.
- **Whisper Prism** *(handed to Evrin S5)* — In Evrin's metal-lined box.
- **Bag of Beans** *(Mist S5)* — 7 magical beans. Plant for effects, dump for explosion. Pending experimentation.
- **Mysterious Orb (depleted)** *(S5)* — Empty crystal. Vision-projector. Can it be recharged?
- **Silas's disappearance** *(S5)* — Magic circle teleport in the Stillwind Lab vault. Was the circle the lab's defense, or a targeted strike at Silas?
- **Long-term contract with Evrin** *(established S5)* — Mist signed on (won signing bonus) + Talya signed on; Akasha extended alliance only; Avon undecided. Code phrase: *"purchase a seagull"* via Crowned Pheasant barkeep. Evrin currently out of town.
- **Vale Tempest amulet (discarded S6)** — Avon memorized the shape; tossed on a rooftop.
- **Wardstone Festival fame** *(S5)* — Public party recognition for Festival defense. Hideout actions still secret.
