...
- **Icewind Dale** — Frozen tundra region gripped by an unnatural, endless winter
- **Ten-Towns** — Collection of settlements in Icewind Dale; each town appeases Auril differently (light, food, or human sacrifice by lottery)

#### Targos
- **Luskan Arms Inn** — Sturdy walls, rotten floorboards, rat problem. Party's starting location
- Starting point of the murder investigation; the shipbuilder (3rd victim) was killed here

#### Bryn Shander
- Largest and most intact of the towns visited; protected by a large circular wall
- **Speaker:** Duvessa Shane — provided evidence against Sephek Caltro
- Torg's Caravan left town in the middle of the night (suspicious)

#### Caer-Dineval
- Named for **The Caer**, one of the last true castles in Icewind Dale
- **The Uphill Climb** — Inn run by Roark; party's base of operations in the area
- **The Caer** — Fortress now occupied by a cult of Levistus. Banner: two black crossed swords (replacing the normal white tower over red fish). Town Speaker Cranic has not been seen since the cult arrived; communicates only through signed letters
- **Dinev's Rest** — Abandoned building with a crooked dragon weathervane. Was a duergar staging point; destroyed by fire after the party cleared it
- Athelas Daenan chose to remain here to watch the cult (departed party Session 4)

#### Caer-Konig
- Town with a crumpled, ruined castle
- **Frozenfar Expeditions** — Guide outfit run by Atenas Swift; provided info on Garrett's mountain route

#### Easthaven
- Site of the public execution of the wizard Dzaan (burned at the stake for murdering adventurers)
- Sacrifices people by lottery (often rigged against vagrants)
- Durth (duergar, white beard in three braids) — one of Xardorok's sons — was last reported here
...
- **Keegan's Hut** — Between Targos and Bryn Shander. Home of Keegan, who directed the party to find Garrett on the mountain
...
- **The Lost Spire** — The upside-down wizard tower from the ancient Netherese floating city **Uthred**, northeast of Easthaven along the lake. A 20-foot spur of smooth, shiny rock jutting from the tundra — part of a structure that continues underground. Entry via a 5-foot burrowed tunnel (claw/burrow markings, steep angle). Interior is inverted: sconces with magical flames burning downward, doors flush with ceilings, stairs collapsed from the inversion.
  - **Floor 2 (entry level):** Library, workshop, alchemy room, laboratory with caged molted humanoid ant carapace, a permanent-Silence study room. Cleared in Sessions 9-10. Wizard's office contains the original Netherese owner's research desk; recovered the silver-framed wooden broom amulet (Shield Guardian bond, far SW) and four books including *From Shadow to Substance* and *Ventitas*. Adjacent altar room contains an upside-down stone altar with a hidden Mystra symbol that activates only within 5 feet of the altar.
...
- **Hlin Trollbane** — Elderly dwarven woman, old scars. Hired the party in Targos to investigate three connected murders (100 gp each). Suspects Sephek Caltro
- **Duvessa Shane** — Speaker of Bryn Shander. Took Hlin's suspicions seriously; provided a leather satchel of evidence connecting Sephek to the murders
...
- **Boy** — Garrett's dog. Led the party to Keegan's hut. Favorite of Garrett's sled dog team
- **Keegan** — Handsome man living in a hut between Targos and Bryn Shander. Reported Garrett missing and asked the party to search
...
- **Dzaan Simulacrum** — Illusory copy of the executed wizard Dzaan, made of "snow and shadow." Appears identical to the original. Has spellcasting up to ~3rd level (observed: Acid Splash, Misty Step, Invisibility). Needs a "life spark" from a living creature to become real, otherwise dissolves in days. Confirmed Krintas (his bodyguard) killed the guides who brought the original Dzaan here. ESCAPED Session 10 combat. Still loose in the Lost Spire or already gone. Will likely seek another life spark. Aware of two more Brotherhood wizards doing similar research
- **Krintas** — DECEASED (Session 10). Wight bodyguard of the Dzaan simulacrum. Withered corpse of a former great warrior. Equipped with longbow and life-drain touch (Con save or HP max reduced). Killed the original guides on Dzaan's order. Burned to death in Thors's restraint chains. Body decapitated by Thors (head up, body down)

### The Caer Cult (Levistus Worshippers)

- **Kadroth** — Tiefling man in fine clothing. Wears a large crystal necklace proudly. Apparent leader of the cult in The Caer. Reprimanded Thoob; asked if the party were "followers of the Chained One"
- **Thoob** — Hairless, skinny, missing teeth. Odd little man who greeted the party at the castle door and served as guide inside
- **The Soothsayer** — Elderly dwarven woman with a peg for a right foot. Had visions from Levistus. Told the party they would "save them" and warned: "Xardorok has a plot to destroy it all, she must be stopped. Destroy the heart." Died immediately after delivering the prophecy. Left behind a necklace (stone on silver chain with sword emblem) — radiates evocation magic, causes dread/discomfort when held. Now carried by Virel
- **Cranic** — Town Speaker of Caer-Dineval. Lives in the tower. Has not been seen since the cult arrived; communicates only via signed letters

### Arcane Brotherhood

- **Avarice** — Wizard, member of the Arcane Brotherhood. Contacted the party through her gargoyle Gurgle in Easthaven. Claims to be "stuck in the basement" of The Caer. Offered information in exchange for a future favor. Warned the party about Vellynne. Said the Brotherhood started with four members in Icewind Dale, now only two remain. Contact via raven
...
- **Athelas Daenan** — Carried a holy symbol of bones (Selune). Healer who lived alone in the snow. Chose to stay in Caer-Dineval to monitor the cult (Session 4). No longer traveling with the party

## Lore

### Auril's Endless Winter
- An unnatural, endless winter grips Icewind Dale
- Each town appeases Auril differently: some sacrifice light, some food, some people
- Human sacrifices occur by lottery on the new moon; lotteries are often rigged to fall on vagrants

### Levistus — The Chained One
- Arch-Devil of the 5th level of the Hells, also known as The Frozen Prince
- Worshipped by the cult occupying The Caer in Caer-Dineval
- The soothsayer received visions from Levistus about Xardorok's plot

### The Fallen Wizard City
- An ancient magical city once held aloft by wizards above Icewind Dale, long before Ten-Towns existed
- The city eventually fell; its remnants are buried and scattered across the dale
- One specific rumor: a magical tower fell from the sky upside down and burrowed into the earth underground
...
- Four such giants were found frozen beneath a former hot spring in the coastal caves

### Drizzt Do'Urden in Icewind Dale
- Drizzt visited the White Lady Inn years ago
- He stayed for a while, writing extensively in a book and asking about the White Lady legend
- Disappeared one night; Bartaban hasn't seen him since

### The Duergar Threat
- Xardorok leads duergar forces from the Underdark into Icewind Dale
- Goal: destroy the surface towns so duergar can live above ground
- Xardorok possesses "the heart of a dragon" — central to the plan
...
### The Netherese Cities — Uthred and Ythryn
- The fallen wizard city this tower fragment came from is **Uthred**. It crashed under the Icewind Dale glacier roughly 2,000 years ago. Most of it is buried elsewhere under the ice
- **Ventitas** — A sister Netherese flying city that disintegrated over the forest of **Cormanthor**, before Uthred fell. Documented in the book *Ventitas* recovered from the tower
- **Ythryn** — A *separate* buried Netherese city the Dzaan simulacrum was researching. The Lost Spire's chamber (illusion-to-reality device) is reportedly cracked; a working version may exist in Ythryn

### Loross
- The ancient wizard language of the Netherese. Used in the illusory maintenance message in the Lost Spire's lowest chamber
- Nobody in the party currently speaks it. **Comprehend Languages** would crack it

### The Illusion-to-Reality Chamber (Lost Spire)
- Lowest floor of the Lost Spire. A small rune-inscribed room with a 5-ft golden crystal disk on the (former) ceiling
- Function: place an illusory object or creature under the disk → it becomes corporeal and real
- Activation requires a "life spark" — the simulacrum claims it does not kill or harm the donor, merely "borrows" life essence
- The walls and runes are cracked from the city's fall; using the device would likely produce negative side effects
- The party has not decided whether to keep, use, or destroy it. The Dzaan simulacrum needs it (or one like it in Ythryn)
...
### Session 1 — The Job and the Road
Party met at the Luskan Arms Inn in Targos. Hlin Trollbane hired them to investigate three connected murders and the suspect Sephek Caltro. On the road, Boy the dog led them to Keegan, who asked them to find the missing guide Garrett on the mountain near Caer-Konig. In Bryn Shander, Duvessa Shane provided evidence against Sephek. Torg's Caravan had left town suspiciously in the night. Session ended with three crag cats encircling the party on the road to Caer-Dineval.

### Session 2 — The Mountain Rescue Begins
Defeated the crag cats. Arrived in Caer-Dineval — noticed the wrong banner flying over The Caer. Stayed at The Uphill Climb. Virel studied the murder notes (consistent piercing weapon, frozen wounds). Traveled to Caer-Konig, met Atenas Swift, and climbed the mountain. Found Garrett's abandoned camp with five starving sled dogs. Survived an avalanche. Found Garrett's bloodied body and killed a crag cat attacking him. Garrett described a yeti attack and three missing climbers. Party camped in a cave with a stone bridge over an 80-foot chasm.

### Session 3 — Yeti Cave and The Caer
Found the remains of Mukingo (goliath — dead), rescued the halfling and tiefling (Asterisks). Killed a mother and male yeti. Descended the mountain and returned to Caer-Konig, then Caer-Dineval. Virel's research found no motive in the murders; Torg, Sephek, and Vex were all named. Roark warned the party about the cult in The Caer. Party entered the fortress, met Thoob, and were taken to the soothsayer — an elderly dwarven woman who prophesied the party would "save them," warned about Xardorok, and said "Destroy the heart" before dying. She left behind a magical necklace (evocation, causes dread). Kadroth, a tiefling cult leader, questioned the party about Levistus and dismissed them.

### Session 4 — Avarath Joins, Duergar Discovered
After leaving The Caer, the party met Avarath Solvane, who had been trying to intimidate his way into the castle. Athelas chose to stay behind in Caer-Dineval to watch the cult. Roark mentioned Xardorok and Dinev's Rest. The party investigated Dinev's Rest — an abandoned building with signs of covert use. Inside, they fought five duergar (invisible) and interrogated a survivor. The duergar revealed: Xardorok ordered them to wait for "the attack," the duergar came from the Underdark to destroy Ten-Towns, Xardorok has "the heart of a dragon," and one of his sons (Durth, white beard in three braids) is in Easthaven. Dinev's Rest burned down afterward.

### Session 5 — Easthaven, Dzaan, and the Séance
Roark noted black smoke and large winged creatures leaving The Caer. Party traveled to Easthaven and witnessed Dzaan's public execution. Rune recalled the legend of the fallen wizard city and the upside-down tower. The gargoyle Gurgle delivered a message from Avarice (Arcane Brotherhood) — she offered an exchange of information for a future favor and warned about Vellynne. Captain Arlath hired the party to find the missing crew of the *Bunch o' Knuckle*. That night, a halfling invited the party to a séance about the White Lady (a woman who died on the lake, treasure sank, husband suspected of murder). The séance produced frost-written messages: "Cauldron," "Caves," "invisible dwarves," "ferry," and "something else here." A specter attacked and was destroyed. Session ended with the terrified halfling on the floor.
...
### Session 10 — Snow and Shadow
Continued mid-exploration of the Lost Spire's Floor 2. Found a Scroll of Invisibility in a sealed chardalyn tube, a small brass key, and necromancy + illusion magic signatures behind a side door. Two figures emerged: a tall wight named **Krintas** and a man identical to the dead wizard **Dzaan**. Dzaan revealed himself as a **simulacrum** — made of snow and shadow, dissolving in days without a "life spark" from a living creature. The lowest floor of this tower contains a **chamber** that turns illusions into reality. The simulacrum's actual research target was finding **Ythryn**, a separate buried Netherese city. He confirmed Krintas killed the original guides on his order. Two other Arcane Brotherhood wizards plus a "fourth tagalong who has died" (feminine pronoun — possibly Avarice) are doing similar research. The party refused to volunteer a life spark; the simulacrum ordered Krintas to kill them all.

Two-round combat. Rune dropped 47 damage on Krintas across both rounds. Avarath Fey Stepped in, Vow of Enmity + Maul + Topple, then Thors's chestplate symbol triggered fiery chains restraining Krintas (DC 15 STR fail). Krintas's life-drain touch reduced Virel's max HP from 23 to 21. Jack burned Hellish Rebuke as a reaction. The simulacrum used a held action Misty Step to the level above when Krintas was bloodied, then cast Invisibility from upstairs the next round and escaped. Krintas burned to death in the restraint chains at start of his round-2 turn.

Short rest aftermath. Virel and Jack searched the wizard's office: a silver-framed wooden amulet with a triple-crescent + staff symbol, four books (*From Shadow to Substance* on illusion-to-reality theory, *Here Lies the King* illusionist novel, *Ventitas* on a sister Netherese city that disintegrated over Cormanthor before this tower's parent city **Uthred** fell, plus an untitled book in Elvish). Virel attuned the amulet — instantly sensed an inactive **Shield Guardian** far southwest. Rune wandered into a small altar room where stepping within 5 feet of an upside-down stone altar transformed an eight-pointed star into the seven-stars-in-a-circle of **Mystra**. A flask of glowing blue liquid dropped into his hand.

Floor 3 was a basilisk encounter. Two-round combat. Rune dealt 22 damage R1 with Hunter's Mark + Dreadful Strike, Avarath bloodied with Vow of Enmity + Smite + Maul, **Jack pulled a previously-unseen pact greatsword** ("Knight of Artorias") with a prayer to his patron — purple energy, eyes change, a tinkling laugh in his head only. Petrification cone caught Rune in stage-1 restraint; he killed the basilisk R2 with a 15-to-hit (regular AC), narrated as an eye-shot kill. DM revealed post-combat that the cracked tall mirror in the next room would have countered the petrification cone if they'd cleared the bedroom first; also that "the baby's somewhere else, going to team up with a yeti." Harvested 3 claws, 2 venomous teeth, 1 intact eye.
