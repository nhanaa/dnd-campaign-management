...
|-----------|---------|-------|:-----:|--------|
| **Avarath Solvane** | Eladrin | Paladin (Oath of Vengeance) | 3 | Paxmanz |
...
- Avarath's **Bless** benefits the whole party — confirmed in Session 8 (enabled Thors' max-damage hit on Sephek)
- **Topple (Maul)** knocking enemies prone gives advantage to Thors and Rune for melee — confirmed in Session 8 (Avarath Toppled Sephek, Thors and Rune attacked with advantage)
- Avarath's **Fey Step** for rapid repositioning — used in Session 8 to teleport into the Sephek fight from a floor away
- **Virel's Sleep** can end fights against single targets — confirmed in Session 8 (Sephek captured alive)

## Former Members

| Character | Species | Class | Player | Status |
|-----------|---------|-------|--------|--------|
...
### Allies & Contacts
- **Timon** — Werebear, met on the lakeshore Session 11. Polar bear form / hybrid form / human (likely). One eye, eyepatch like Oakley sunglasses, dreaded beard. Hunting **Oya Minartok**, a famous local werebear legend who he believes is his mother. Shared fish and a fire with the party. Friendly, generous. Reported the chardalyn cave east of the lakeshore — quest hook
- **Easthaven Apothecary Woman** — Elderly human, hunched, very short. Knows Underdark / basilisk crafting on sight. Holds prices firm (Session 11)
- **Hlin Trollbane** — Hired the party to investigate the murders. Trusts them with the job. 100 gp each on completion
- **Duvessa Shane** — Cooperative; provided evidence against Sephek. Sympathetic to the investigation
- **Roark** — Friendly innkeeper at The Uphill Climb. Has been a reliable source of local information. Hopes the party's actions stabilize Caer-Dineval
- **Captain Arlath** — Professional relationship. Hired the party to find the missing *Bunch o' Knuckle* crew. Paid out after completion. Delivered Dzaan's bag as promised
- **Bartaban** — Owner of the White Lady Inn. Grateful for saving his bar; gave free rooms. Source of historical info (Drizzt, local gossip). Session 7: saw Kane (as a giant spider) drag a webbed dwarf into his bar and politely went upstairs without asking questions
- **Speaker Dennis Whalen** — Town Speaker of Easthaven. Bought the Cauldron of Plenty for 5,000 gp in gemstones (1 down, 9 remaining). Session 8: Prudence betrayed him, stole the cauldron. Whalen locked in his own dungeon. Can't pay remaining gemstones without the cauldron — contract clause requires it present in 48 hours. Genuinely upset, not suspicious
- **Avarice** — Transactional. Arcane Brotherhood wizard offering info in exchange for a future (undefined) favor. Contact via raven. Currently "stuck in the basement" of The Caer
- **Garrett** — Grateful for rescue. Denied knowledge of Torg's Caravan

### Adversaries & Unknowns
- **Sephek Caltro** — CAPTURED (Session 8). Serial killer serving Auril — kills people who paid off officials to avoid sacrifice lotteries. Undead (necromancy through entire body). Ice sword (separate magical item, painfully cold). Attacked Kane in his sleep, killed him with max damage. Captured alive via Virel's Sleep spell. Gagged, hooded, turned in to Easthaven guards with caster's muzzle. Claims Auril's "blessing." Never seen her but says she's "inside" him. Not dressed for cold. Can he be held?
- **Prudence** — Former assistant to Speaker Whalen. Betrayed him in Session 8: called in accomplices, held knife to Whalen's throat, locked him and all guards in the dungeon, stole the Cauldron of Plenty. Fled toward Targos. Unknown affiliations
- **Torg Icevein / Torg's Caravan** — Suspect organization. Fled Bryn Shander at night
- **Kadroth** — Cult leader in The Caer. Dismissed the party; unclear if hostile or indifferent
...
### Leads & Hooks
- **The Chardalyn Cave (East of Lakeshore)** — Timon reported it Session 11: men corrupted by chardalyn weaponize the stones, speak broken common, violent and frightening. Possibly a Xardorok scout cache or staging cell. Timon recommended putting them out of their misery; Thors flagged the "humane to get rid of them" framing
- **Oya Minartok** — Famous local werebear legend, Timon's possible mother. The party can ask around the Ten-Towns (Roark, Salen Para, Atenas Swift, Bartaban all candidates)
- **The Sea of Moving Ice (confirmed coldest part of the Dale)** — Far-north ocean of Icewind Dale, ringed with mist-and-storm-hidden islands. Largely unreachable. Auril is said to live somewhere in Icewind Dale (Virel's Religion 22); the Sea of Moving Ice is the working hypothesis for where. Going north is now on the table for Virel and likely Avarath
- **Jack's Organization** — Confirmed to exist (Session 11). Pays his postal bills through a pre-arranged Easthaven account. Requires Jack to maintain "selective information gathering." Goals, members, and what Jack is reporting back are unknown
...
- **Thors's Neverwinter Past (Session 11 reveal)** — Thors is from the Sword Coast — specifically Neverwinter ("you never really see a winter that often"). Wears a hidden gray cloak under his outer cloak: his old guard cloak. He was a guard there before leaving. *"I did things as a guard."* In hiding from something on the Sword Coast. Won't say what
- **Thors's Enlarge Ability (Session 11)** — Thors used a previously-unseen ability to grow medium-to-large (filling four squares, advantage on STR checks) on his initiative turn against the bugbears. Source not revealed in the transcript — could be a magic item, potion, feat, or subclass feature. Worth a clarifying ask with Karl
- **Avarath's Father (Session 11 reveal)** — Died about two years ago, cause unknown. Avarath came to Icewind Dale chasing a clue. Loss is the freshest grief at the table — DM canonized this. The two-year timing matches the campaign's two-year unnatural-winter onset, consistent with Avarath's House Solvane backstory
- **Virel's Father (Session 11 reveal — now table knowledge)** — Died decades ago, cause unknown. Knew Drizzt. Virel is in Icewind Dale to chase the Drizzt lead. She is from Menzoberranzan
- **Rune's Vanished Village (Session 11 reveal)** — Rune is from an alpine village in the Spine of the World. Came back from a one-month trading trip ~5 years ago to find his whole village/people gone. No bodies, no messages, no signs of struggle. Has been wandering the Ten-Towns ever since. Considers them his unsolved mystery. Five-year cold case
...
### Resolved
- **Bugbears in the Lost Spire (Session 11)** — Six bugbears took shelter from a blizzard in the entry level of the Lost Spire. Brack the leader killed; the remaining five fled down the hole and out. Lost Spire now empty of new occupants (Dzaan simulacrum still loose somewhere, but the bugbears are gone). Loot: Brack's morningstar (sold 9 gp in Easthaven)
...
- **Duergar at Dinev's Rest** — Five duergar killed/captured. Dinev's Rest burned. Intel gained on Xardorok's plans
- **Find the Bunch o' Knuckle** — Crew confirmed dead (stripped of meat by the sea hag). 600 gp recovered from a waterlogged chest. Magical Cauldron of Plenty recovered and sold to Speaker Whalen for 5,000 gp in gemstones. Dzaan's belongings delivered as promised (Fireball scroll, gray Bag of Tricks, components)
- **Durth (Xardorok's son)** — Located on the Easthaven Ferry, captured non-lethally, tortured by Virel, executed by Rune after revealing Sun Blight Fortress location
- **Murder Investigation** — Sephek Caltro captured alive in Session 8 after killing Kane. Turned in to Easthaven guards. Bounty collection from Hlin Trollbane in Targos still pending (100 gp each)
- **The White Lady Ghost** — Destroyed in Session 8. Was bound to the Errtu figurehead in the Easthaven town hall. Visible only to the party due to the séance. Connected to the séance clue "Something else here"
- **The Séance Clue: "Something else here"** — Was the White Lady ghost, bound to the Errtu figurehead in the town hall basement. All séance clues now resolved
