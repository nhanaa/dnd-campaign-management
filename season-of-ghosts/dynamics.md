# Season of Ghosts — Party & NPC Dynamics

## Party Roster (current ~L3)

### Mo (Pax) — Wayang Rogue (Thief) + Spirit Warrior FA
- **Lane**: Stealth scout, off-guard chainer, melee burst.
- **Setup tools**: Stealth init (auto round-1 off-guard), Dance of the Mousedeer (cover/Hide loops), Slink Away (reposition).
- **Damage**: rapier (1d6+4 + 1d6 sneak) + fist via Handwraps + Overwhelming Combination 2-Strike combo.
...
- **Mo connection (potential)**: Both walk on the edge of legality. Different flavors of "outsider" — Mo is the foundling, Atlacoya is the loner-hunter.

### Myo Jun-Yeong (Rommy) — Human Duskwalker Sorcerer (Psychopomp) + Soul Warden + Familiar Master
- **Lane**: Divine spellcaster (Heal, Soothe, Divine Lance), spirit-warden role.
- **Pattern**: CHA-key sorcery, Pharasma-aligned anti-spirit toolkit.
...
## Off-Guard Economy (Mo's lane)

The party already runs heavy off-guard discipline. Mo joining adds a *third* off-guard generator:
...
- Lung Wa-appointed authority. Keeps order despite the empire's collapse.
- Caught Mo lying/stealing as a kid more than once. Never turned him in.
...
- Currently **missing**. Manor vanished without trace overnight.
- Three years ago, deliberately failed to arrest Fan Hongrui (the rebel). Likely the load-bearing decision behind the curse.
- Played Zhi Hui at the Reenactment Festival; gave the ominous "no matter how many cycles" speech.

#### Fan Hongrui
- Lung Wa rebel/fugitive who died in an inn fire 3 years ago.
- Cursed the governor with her dying breath: *"All those who serve Lung Wa will soon know how it feels to lose everything."*
...
- Vanished during the invasion, recovered at the Gorge of Fangs and Teeth.
- Source of the red-butterfly vision.
- **Mo's spiritual focus**: Mo bows to Ugly Cute wherever the statue is. Foundling-to-foundling identification — both the town's "weird thing it adopted."

#### Noppera-bo Rebel
- Faceless yokai who offered the party an alliance against the Crimson Stain cult's leader.
- Will signal when the cult returns from the monastery so the party can strike at "her."
- **Party accepted the deal.**
...
- DM said the joining hook is straightforward: hidden through invasion → inspired by the party → tagging along now.
- Backstory matters most for *interpersonal relationships with townsfolk*, not large lore reasons. **You're a local kid, not an outsider.**
- Mo has no plot-load-bearing secrets to maintain. He's the everyman whose perspective is "I survived, you saved my home, I want to help."
