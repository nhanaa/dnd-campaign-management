# Session 1 Recap — Friends of the Rose

**Date**: April 11, 2026
**In-game date**: Wheel Day, 7th of Lamson, 4726 AR
...
| Character | Ancestry / Class | Player |
|-----------|------------------|--------|
...
- **Morning of the 8th of Lamson.** The town's mood has flipped. A decree from *Stuart Hedvind VI* has been posted: cash rewards for turning in suspected rebels. Brynn Tate slams a copy down on the bar.
...
- Three-quarters of a day's travel later, the party arrives in **Saringallow**. Ethran leads them to a nondescript mansion on the east side of town — formerly owned by aristocrats who were run out.
- **Passphrase**: *"Friends of the Rose"* — a reference to **Milani**, the goddess of revolution and rebellion.
- The door opens into a modest parlor. The woman there walks to the fireplace, runs her hand along the top, and a hidden door clicks open. Stairs lead down into a wide basement crammed with tables, maps of Isger, and ledgers.
...
- *"I can't imagine anyone would normally trap a section of a warehouse unless they were expecting trouble,"* Cyrathul notes.
- Weapons out. The party advances cautiously around the corner. Four figures stand in the next room — and the big burly woman in the back greets them:
...
### Cyrathul
- **Rolled out of the gate** with a deadpan dragon-in-a-tavern bit: *"Just for clarification, I am medium-sized."*
- **Won the tavern contest crowd** (before Fang upstaged him) by reciting a battle "I observed from my lunar observatory" via Esoteric Lore — and then bowing with his wings.
- Delivered the session's mythic backstory beat during travel: *"For a while, the majority of my life I was... I guess you could call me an observer from the moon, as most of my kind are. I just got tired of being unable to do things, so I took drastic measures, and now I am here."*
- In combat: **Exploit Vulnerability** → **Demoralize** → **Mirror Cloak (Mirror Image)** → attacks *through the mirror image* with a longsword drawn from behind a wing. Kaazz leaned all the way into the imagery: *"He has a sheathed longsword tucked behind a wing. He just takes it with his claw, draws it, and attacks through the mirror behind the bat."*
- **Identified the dread bats' weaknesses mid-fight** via Exploit Vulnerability: *"It is weak to slashing damage, by the way."* — the mechanical pivot that let Bai Jian and Fang lean into slashing strikes for the kill.

### Panacea
- The quiet one. Watched and drank in the tavern scene; said more through nods than words.
- Opened combat with **Needle Darts** (missed) then landed **Divine Lance + Trade Life for Death hex** on the dread bat. The hex's fortitude save failed — but the bat had **no life to drain**, revealing it as undead. The hit still triggered **Stupefied 1** via the Familiar of Paired Perplexity.
- Echoed Cyrathul's Exploit Vulnerability read late in the fight: *"I think it's weak to vitality and slashing."*
- Provided the session's **first Battle Medicine** of the campaign when Bai Jian took 14 damage in the warehouse trap. Treat Wounds was a VTT fumble on the first attempt, but she stuck the hero point reroll.
...
### Encounter 1 — Dread Bats at the Ferry Crossing (Combat)
**Setting**: North Kansira River bank, dusk, party waiting for the ferry.
**Enemies**: Two undead/dread bats, flying in fast from the horizon.
**Resistances/Immunities** (learned mid-fight):
- **Weak to**: slashing, vitality (positive) damage
- **Immune to**: mental effects, paralyze, poison
- **Undead** — no "life" to drain

**Key rolls / beats**:
- Surprise perception check: everyone succeeded → party got **+1 circumstance bonus to initiative**.
- **Bai Jian crit opener**: 24 damage across the lead bat's wings.
- **Cyrathul Mirror Cloak combo**: Exploit Vulnerability → Demoralize → Mirror Cloak → longsword strike through the mirror image behind the second bat. Described in loving detail by Kaazz.
- **Fang crit closer**: Overdrive + Wing pop-a-wheelie → bat crushed into a medium-sized divot in the ground.
- **Neither bat got a turn.** *"I can't believe how fast you took down the two bats,"* Kaazz said at the end. *"We have to tune some stuff up to make it more challenging for you."*
- **Reward: 96 XP each.**

### Encounter 2 — The Warehouse Trap & Standoff (Trap → Cliffhanger)
**Setting**: Everbloom Imports warehouse, Saringallow dockside. Front door barred. Side door unlocked but trapped.

**Trap**: Hairline tripcord tied to a crate pile above the side door.
- **Bai Jian** failed the reflex save → **14 damage + prone + off-guard.**
- Panacea's **Treat Wounds via Battle Medicine** — failed on the first roll, succeeded on the hero point reroll.

**Standoff**: Party rounds the corner into a large warehouse room. **Four figures** are waiting. The big burly woman in the back greets them:

> **"Like rats in a trap."**

**Session ends. Combat (or parley) resolves next session.**
...
- 📜 **Hedvind VI's Bounty Decree**: A neighbor-against-neighbor witch hunt is about to escalate. Alceo and Phoebe are in Eladir trying to stop the fallout. Non-Hellbreaker civilians are already feeling the pressure.
...
> **Bai Jian**: *"A dragon? What such creature is doing here?"*
> **Cyrathul**: *"Just for clarification, I am medium-sized."*
> **Bai Jian**: *"Well, your wings probably might get taller."*

> **Bai Jian** (to Ethran, on the road): *"I guess I can sympathize with the cause. My homeland is also ravaged by the greed of the dictatorship."*
...
> **Otto the Ferryman**: *"My cousin told me the dead have been mighty restless ever since all that god-stuff fell from the sky. She thinks it has something to do with the lich that lives on Lake Encarthan."*

> **Cyrathul** (standing over a collapsed Bai Jian and a pile of crates): *"Well, there goes the element of surprise. I can't imagine anyone would normally trap a section of a warehouse unless they were expecting trouble."*

> **The Burly Woman**: *"Like rats in a trap."*
...
- **"The other person I fought beside" is Bai Feng.** Nobody at the tavern asked who. The hook is dropped for someone to pull on later. Don't volunteer.
- **Sovereign Dragon crit-on-fear-saves** is live. If the party eats a fear effect, Bai Jian is the anchor.
- The jian is Bai Feng's legacy, not just a weapon. That is why agreeing to hand it over for the rune transfer felt like a ceremony and not a transaction.
