...
- **Face/Social**: Bai Jian (Diplomacy, Intimidation — but CHA dropped to 10 in the respec, so checks are skill-prof only), Moob (deception / humble-goblin routine). Incoming Bard (S8) likely takes over primary face duties.
>>>>>>> Stashed changes
...
- **Viro Ahala** — (**DECEASED, S9**) Imposter Hell Knight, not actually a member of the Order. Deceived Sister Endreah and the Golden Erinyes to source a devil-summoning ritual. **Killed by the party in his Stagfall ritual chamber** before his **greater-summoning ritual** (a gate for a greater devil targeting the Chitterwood goblins) could resolve. **Why he was a "fake" Hell Knight was never learned** — killed before interrogation; his body + Hell Knight plate were bagged for identification at HQ. Still distinct from **Hellknight Alaya** (at large); whether a *real* Hell Knight is behind the mask is open.
...
=======
- **Two New Members** (incoming, S8): The DM and Bracknap both foreshadowed two new "Longshanks." **One confirmed to be a Bard** (occult support — the party's first); the other's class unknown. The party is holding the 250-gp / level-6 shield and a spare potency rune in the stash for them.
>>>>>>> Stashed changes
...
- **Viro Ahala's Chitterwood Ritual** (**RESOLVED S9**): Stagfall fully cleared; Viro killed before the greater-summoning ritual resolved. Open follow-ups: why he was a "fake" Hell Knight, whether a *real* one / **Alaya** is connected, and whether anything came through the gate before it snuffed out.
- **Reputation maxed (S9)**: Hellbreaker reputation hit **20 (maximum tier)** — the League is now "the best chance for Isger's future." Hearts-and-minds tour and the Viro mission both complete; next major front is open (Saringallow/Rhokrag, the Lake Encarthan lich, or Hedvind's Thrune escalation).
- **Pendant of the Occult** (acquired S9): Bracknap's permanent gift, the spent Crystal Pendant reforged with his grandmother's essence. New party occult item; bearer TBD.
- **Cyrathul's near-death (S9)**: First party member to drop to dying since Rama (Stagfall waterfall fight) — recovered. A reminder the party's healing still leans hard on Panacea.
